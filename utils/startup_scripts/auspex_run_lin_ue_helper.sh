...
gnome-terminal --tab --title="AERO" -- bash -i -c "vasa_cmd \"aero_run count:=$platform_count\""
gnome-terminal --tab --title="Height Server" -- bash -i -c "vasa_cmd \"height_server_run\""
gnome-terminal --tab --title="Valkey Server" -- bash -i -c "vasa_cmd \"valkey_run\""
...
# Run PX4 in the main terminal using interactive bash
bash -i -c "vasa_cmd \"px4_run $platform_count\""